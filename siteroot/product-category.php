<?php
  ...
  //shows what product we're trying to show from which category
  //URL will look like: ../products.php?category_id=X
...
<?php
  $query = "SELECT products.product_id, product_images.image, products.name, reviews.rating, products.price, products.added_date
            FROM products, product_images, reviews, categories, product_categories
