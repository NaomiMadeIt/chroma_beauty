...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 10, 2017 at 02:47 PM
...
(4, 'Pretty Poison', 'Available Colors: Chubby, Detox, Girl Crush, Nurse, Spank, and U4EA.', '20.00', '2017-03-10 02:11:39', 0, 1);
...
(8, 'Great Colors! Very Vibrant!', 'The colors are super pigmented, apply smooth, and feel moisturizing! However, I noticed that the lipstick feathers after some time of wear, which can look really awkward, especially with the U4EA color! I still really love it!', 4, '2017-03-10 02:17:26', 1, 4, 1, 1);
...
(1, 'Naomi', '842c8c63427efeb9f36a8521d902bb4968244254', 'naomi.k.rodriguez@gmail.com', 'Naomi', 'Rodriguez', 'Hello! My name is Naomi, and I am OBSESSED with great makeup!', '6cc52da051635933d07e7ad0848a213230c77815', 1, '2017-03-02 16:32:03', 1, 'b41e1edaa6f6b5dc1dc0aabc12a520daec69c932'),
...
(5, 'Kiana', '33c7cf4947f2c2e12dce16d52dfc750db14f9b9e', 'thisisanemail@emailsareemails.com', 'Kiana', 'Monet', 'Make up gives me life!', 'a2da8f9b2f5e7c00bec6b2103226f7238b5955aa', 0, '2017-03-10 01:36:39', 1, '9833efe32f847fabace8002ea6768cd554742c64');
...
--
ALTER TABLE `products`
  MODIFY `product_id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `product_categories`
--
ALTER TABLE `product_categories`
  MODIFY `prodcat_id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `product_images`
--
ALTER TABLE `product_images`
  MODIFY `prodimg_id` smallint(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `reviews`
--
ALTER TABLE `reviews`
  MODIFY `review_id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
